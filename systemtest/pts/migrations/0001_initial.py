    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('serial_number', systemtest.utils.models.CharFieldUpper(blank=True, default=None, help_text='12 caracteres', max_length=12, null=True, validators=[django.core.validators.RegexValidator('^[a-zA-Z0-9]{12}$')], verbose_name='Numero de Seria [ SN ]')),
                ('created', models.DateTimeField(auto_now_add=True, help_text='Fecha y hora de solicitud', verbose_name='Creacion')),
                ('comment', systemtest.utils.models.CharFieldUpper(blank=True, default='', help_text='Comentario adicional en estado actual', max_length=30, null=True, verbose_name='Comentario')),
                ('ncm_tag', models.PositiveIntegerField(blank=True, help_text='Numero de Tag en caso de tener', null=True, unique=True, validators=[django.core.validators.MinValueValidator(10000000), django.core.validators.MaxValueValidator(99999999)], verbose_name='NCM')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qty', models.SmallIntegerField(default=1, help_text='Cantidad de piezas del mismo PN', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)], verbose_name='Cantidad')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request', models.ForeignKey(help_text='Numero del requerimiento original, con el estado actual', on_delete=django.db.models.deletion.PROTECT, related_name='request_history', to='pts.request', verbose_name='Requerimiento')),
                ('request_status', models.ForeignKey(blank=True, default=1, help_text='Estado del requerimiento', on_delete=django.db.models.deletion.PROTECT, to='pts.requeststatus', verbose_name='Estado')),
            ],
            options={
