    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shift', models.PositiveSmallIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='Shift')),
                ('mfs', systemtest.utils.models.CharFieldUpper(blank=True, help_text='Manufactoring Floor System User', max_length=30, null=True, verbose_name='MFS')),
                ...
                ('job', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='users.job', verbose_name='Job')),
